...
## References
* This is a fork of kz8s - tack, and my complete remake will be https://github.com/arehmandev/Prototype-X
* [CFSSL: CloudFlare's PKI and TLS toolkit](https://cfssl.org/)
* [CoreOS - Mounting Storage](https://coreos.com/os/docs/latest/mounting-storage.html* [Deploying CoreOS cluster with etcd secured by TLS/SSL](http://blog.skrobul.com/securing_etcd_with_tls/)
